---
title: "Stat Comp HW#1 Jason Rights"
...
Judging purely by the size of the coefficients, Gender seems to have the highest effect.
...
The intercept estimate is 3.5. The estimate for gender is 4.3. 
...
The standard errors for the intercept and gender estimate are 1.098701 and 1.474061, respectively.  
...
```{r}
2*pt(2.917,df=7,lower.tail=FALSE)
```

The p-value is 0.02243567. 
...
The model summary seems to match the "var.equal" one. 
